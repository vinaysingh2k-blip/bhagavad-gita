/* ==========================================================================
   Page-specific configuration — Landing Page 3: "Gita for Harmony & Balance"
   Loaded BEFORE ../assets/main.js. Replace placeholders before launch.
   ========================================================================== */
window.PAGE_CONFIG = {
  PRODUCT_NAME: 'Gita for Harmony & Balance — 12-Chapter Illustrated Companion',
  DOWNLOAD_FILE: '../assets/downloads/gita-for-harmony-balance.pdf',
